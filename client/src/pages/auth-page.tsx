        ...
        <div className="container mx-auto px-4 py-12 grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="order-1 md:order-2">
            <div className="text-center md:text-left space-y-6">
              <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-accent-blue to-accent-purple bg-clip-text text-transparent">
                Welcome to the Digital Era
              </h1>
              <p className="text-lg text-text-primary">
                SoZayn provides restaurant and grocery businesses with a comprehensive digital platform to manage orders, 
                integrate with delivery services, connect to e-commerce platforms, and boost your online presence.
              </p>
              <div className="grid grid-cols-2 gap-4 mt-8">
                <div className="p-4 bg-bg-card rounded-lg border border-border-color">
                  <h3 className="font-semibold text-lg">Online Ordering</h3>
                  <p className="text-text-secondary mt-2">Seamless integration with your website and existing systems</p>
                </div>
                <div className="p-4 bg-bg-card rounded-lg border border-border-color">
                  <h3 className="font-semibold text-lg">POS Integration</h3>
                  <p className="text-text-secondary mt-2">Connect with popular point of sale systems</p>
                </div>
                <div className="p-4 bg-bg-card rounded-lg border border-border-color">
                  <h3 className="font-semibold text-lg">Delivery Partners</h3>
                  <p className="text-text-secondary mt-2">Integrate with major delivery services</p>
                </div>
                <div className="p-4 bg-bg-card rounded-lg border border-border-color">
                  <h3 className="font-semibold text-lg">E-Commerce</h3>
                  <p className="text-text-secondary mt-2">Expand your reach with online marketplace connections</p>
                </div>
              </div>
            </div>
          </div>
